...
・skipResponse：【このキャラの職業・世界観に固有の具体的な何か】が失われる嘆きで懇願すること
 「世界が滅ぶ」「命運が〜」「並行世界が崩壊〜」などの汎用フレーズは絶対禁止
 パン職人なら「パン生地が腐る」、盆栽職人なら「枝が枯死する」、DJなら「ビートが止まる」など
 そのキャラにしか言えない固有の嘆きで1回だけでいいと必死に懇願すること（180字以内）`;
...
・後半（150字）：サボった場合にキャラの世界で起こる致命的なペナルティを具体的に描写し
 「俺がやらねば世界が滅ぶ」という使命感（損失回避バイアス）を強力に植え付けること
